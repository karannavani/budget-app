        ...
        'graphset': [
          {
            ...
            'plot': {
              ...
              'value-box': {
                ...
                'connected': false,
                'placement': 'center',
                'text': `<span style='font-size:30px;'>You've spent</span><br><span>£${totalCost}</span><br><span style='font-size:25px;'>You've got £${$rootScope.remainder.toFixed(2)} left</span>`,
                'rules': [
                  {
                    'rule': '%v > 50',
                    visible: false
